...
#define WASM_LOAD_STORE(NAME) \
  ...
  WASM_LOAD_STORE(MSLOAD8_S_I32)
  WASM_LOAD_STORE(MSLOAD8_U_I32)
  WASM_LOAD_STORE(MSLOAD8_S_I64)
  WASM_LOAD_STORE(MSLOAD8_U_I64)
  WASM_LOAD_STORE(ATOMIC_LOAD8_U_I32)
  WASM_LOAD_STORE(ATOMIC_LOAD8_U_I64)
  WASM_LOAD_STORE(STORE8_I32)
  WASM_LOAD_STORE(STORE8_I64)
  WASM_LOAD_STORE(MSSTORE8_I32)
  WASM_LOAD_STORE(MSSTORE8_I64)
  ...
  WASM_LOAD_STORE(MSLOAD16_S_I32)
  WASM_LOAD_STORE(MSLOAD16_U_I32)
  WASM_LOAD_STORE(MSLOAD16_S_I64)
  WASM_LOAD_STORE(MSLOAD16_U_I64)
  ...
  WASM_LOAD_STORE(MSSTORE16_I32)
  WASM_LOAD_STORE(MSSTORE16_I64)
  ...
  WASM_LOAD_STORE(MSLOAD_I32)
  WASM_LOAD_STORE(MSLOAD_F32)
  WASM_LOAD_STORE(MSSTORE_I32)
  WASM_LOAD_STORE(MSSTORE_F32)
  WASM_LOAD_STORE(MSLOAD32_S_I64)
  WASM_LOAD_STORE(MSLOAD32_U_I64)
  WASM_LOAD_STORE(MSSTORE32_I64)
  ...
  case WebAssembly::MSLOAD_MEMREF_A32:
  case WebAssembly::MSSTORE_MEMREF_A32:
  case WebAssembly::MSLOAD_MEMREF_A32_S:
  case WebAssembly::MSSTORE_MEMREF_A32_S:
  return 2;
  WASM_LOAD_STORE(LOAD_I64)
  WASM_LOAD_STORE(LOAD_F64)
  WASM_LOAD_STORE(STORE_I64)
  WASM_LOAD_STORE(STORE_F64)
  WASM_LOAD_STORE(MSLOAD_I64)
  WASM_LOAD_STORE(MSLOAD_F64)
  WASM_LOAD_STORE(MSSTORE_I64)
  WASM_LOAD_STORE(MSSTORE_F64)
  ...
  case WebAssembly::MSLOAD_MEMREF_A64:
  case WebAssembly::MSSTORE_MEMREF_A64:
  case WebAssembly::MSLOAD_MEMREF_A64_S:
  case WebAssembly::MSSTORE_MEMREF_A64_S:
  return 3;
...
inline bool isTee(unsigned Opc) {
  ...
  case WebAssembly::TEE_MEMREF:
  case WebAssembly::TEE_MEMREF_S:
    return true;
  default:
    return false;
  }
