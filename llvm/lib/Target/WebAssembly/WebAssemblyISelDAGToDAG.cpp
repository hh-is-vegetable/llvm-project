...
void WebAssemblyDAGToDAGISel::Select(SDNode *Node) {
  ...
  case WebAssemblyISD::RET_CALL: {
    ...
    //   MachineSDNode* ZeroConstNode = CurDAG->getMachineNode(WebAssembly::CONST_I32, DL, MVT::i32, CurDAG->getTargetConstant(0, DL, MVT::i32));
    //   SDValue ZeroConst(ZeroConstNode, 0);
    //   MachineSDNode* AllocNode = CurDAG->getMachineNode(WebAssembly::MEMREF_ALLOC, DL, MVT::memref,
    //                                                     AllocBase, AllocSize, ZeroConst);
    ...
    //   SmallVector<SDValue, 16> AllocOps = {BaseVal, NullVal, AllocBase};
